...
int main(int argc, char **argv) {
  ros::init(argc, argv, "sendData2ship2");
  ros::NodeHandle nh;
  ...
  //////////////////////////////////////////////////////////需要完善的
  //订阅需要的消息
  ros::Subscriber shiodata_sub =
      nh.subscribe("ship1_data", 1, shipdata_Callback);
  ...
  while (ros::ok()) {
    ...
    std::cout << "Message send to ship2 :" << bufsend << std::endl;
